...
groq_client = Groq(api_key=os.environ.get("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"))def get_explanation(query, case_title, case_text, verdict, ipc_sections):
